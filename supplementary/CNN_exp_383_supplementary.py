...
# Define root directory
root_dir = r'D:\OneDrive\Documents\Imperial\Data\images\383\drill_disturbances\manual\tmp_binary'
...
source_ext = r"for_training"
source_path = os.path.join(root_path, source_ext)
test_ext = r"tmp_binary\testing"
validation_ext = r"tmp_binary\validation"
train_ext = r"tmp_binary\training"
...
os.chdir(r'D:\OneDrive\Documents\Imperial\Data\images\383\drill_disturbances\manual\tmp_binary')
train_path = 'training'
validation_path = 'validation'
test_path = 'testing'
